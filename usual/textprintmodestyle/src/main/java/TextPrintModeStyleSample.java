...
public class TextPrintModeStyleSample {
    ...
    public void Sample(String printerName){
        ...
        try {
            ...
            Logger.getLogger(TextPrintModeStyleSample.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String[] args) {
        ...
        TextPrintModeStyleSample obj = new TextPrintModeStyleSample();
        obj.Sample(args[0]);
